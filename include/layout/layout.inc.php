...
function menu_management () {
    ...
    dropdown ("Users", [["List users", "/admin/users"] , ["User types", "/admin/list_user_types"]]);
    ...
    dropdown ("Email Rules", [["Regex Rules", "/admin/list_restrict_email"],["Test Email","/admin/test_restrict_email"]]);
