...
function title_decorator ($color, $rotation = "0deg", $img = "arrow.png") {
    ...
    switch ($color) {
        ...
        case "yellow": $colorcode = "#ffc629"; break;
        case "red": $colorcode = "#ce0e2d"; break;
...
function menu_management () {
    ...
    dropdown ("Users", [["List users", "/admin/users"] , ["User types", "/admin/list_user_types"] , ["Bulk Registration", "/admin/bulk_register"]]);
